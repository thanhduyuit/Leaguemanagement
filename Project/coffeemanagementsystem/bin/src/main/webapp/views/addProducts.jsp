			...
			<div class="modal-content">
				...
				<form class="form-horizontal" style="font-size: 14px;"
					...
					<div class="modal-footer">
						<button type="submit" id="submitAddProduct"	class="btn btn-primary">Save</button>
						<button type="button" id="buttonCancelAddProduct" class="btn btn-primary" data-dismiss="modal">Cancel</button>
					</div>
				</form>
			</div>
		</div>
