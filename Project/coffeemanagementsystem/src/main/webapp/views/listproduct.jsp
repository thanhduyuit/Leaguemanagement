...
<!-- 				<input type="hidden" id="idtoDelete"/> -->
	...
	<div class="right-block"
		...
		<a href="javascript: void(0)"	class="btn btn-primary addform" data-toggle="modal" data-target="#addProduct">Thêm sản phẩm</a>
		<div id="addform"></div>
	</div>
	<%@ include file="updateProducts.jsp" %>
	<%@ include file="showProducts.jsp" %>
</body>
<script type="text/javascript" src="resources/js/validateproduct.js"></script>
