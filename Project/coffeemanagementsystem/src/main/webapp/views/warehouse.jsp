					...
					<form action="" class="themHangForm1" id="themHangForm">
						<div class="form-group">
							<label for="exampleInputPassword1">Loại hàng</label><br> <select
								class="materialType" id="materialType" name="materialType"
							...
							<button type="button" class="btn btn-default"
								id="btnDialogMaterType" data-toggle="modal"
								data-target="#addMaterialType" style="border-color: #ADADAD;">Thêm
								loại hàng mới</button>
							<br> <span class="span" id="materialTypeError"></span>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="exampleInputPassword1">Giá</label> <input type="text"
								...
								onkeyup="this.value=FormatNumber(this.value)" name="inputPrice"
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="5"
								placeholder="Mô tả cho mặt hàng ..." id="inputDescription"></textarea>
							<br> <span class="span" id="descriptionError"></span>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default"
								id="btnClosePopupWarehouse" data-dismiss="modal"
					...
					<form action="AddMaterialTypeController" class="themHangForm"
						...
						<div class="form-group">
							<label for="exampleInputPassword1">Tên loại hàng</label> <input
								type="text" class="form-control" id="nameMaterialTypes"
								placeholder="Nhập tên loại hàng" required><br> <span
								class="span" id="nameMaterTypeError"></span>
						</div>
						<div class="form-group">
							<label for="comment">Mô tả</label>
							<textarea class="form-control" placeholder="Mô tả loại hàng"
								rows="5" id="materialTypeDescription"></textarea>
							<br> <span class="span" id="materialTypeDescriptionError"></span>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default"
								data-dismiss="modal" style="border-color: #ADADAD;"
								id="btnCloseMaterType1">Hủy</button>
							<button type="button" class="btn btn-default"
								id="btnSaveMaterType" style="border-color: #ADADAD;">Thêm</button>
						</div>
					</form>
				</div>
			</div>
	...
	<div id="delete-modal" class="modal fade" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<label style="align: center">Bạn có chắc muốn xóa loại hàng
						 này khỏi danh sách không?</label>
				</div>
				<div class="modal-footer">
