...
<link rel="stylesheet" type="text/css" href="resources/css/warehouseViewDetails/viewDetails.css">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<hr>
				<button type="button" id="btnViewDetails" class="btn btn-primary col-md-2">Kế tiếp</button>
			...
			<div class="modal-footer">
				<b style="float: left;">Mã mặt hàng tiếp theo: <span
					id="indexViewDetails"></span></b>
...
<script type="text/javascript"
	src="resources/js/warehouseViewDetails/viewDetails.js"></script>
