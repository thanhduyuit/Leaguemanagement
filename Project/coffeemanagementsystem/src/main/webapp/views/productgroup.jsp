...
<body>
	<!-- table data -->
	<div>
		<button type="button" class="btn btn-default btn-arrow-left" id="backtolistproduct" style="margin-top: 10px">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" align="center">Bạn muốn xóa Nhóm sản
						phẩm này ?</h4>
						<h5 style="color: red;" align="center">(Các sản sản phẩm trong nhóm này sẽ bị xóa theo)</h5>
				</div>
				...
				<form class="form-horizontal" role="form"
					...
					<div class="form-group">
						...
						<label class="control-label col-sm-3" for="namegroup">Tên
							Nhóm:</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="namegroupedit" name="namegroupedit"
					...
					<div class="form-group" align="center">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<button type="submit" name="editsubmit" class="btn btn-success" >Sửa</button>
				...
				<form class="form-horizontal" id="addform">
					...
					<div class="form-group">
						<label class="control-label col-sm-3" for="namegroup">Tên
							Nhóm:</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="namegroupadd" name="namegroupadd"
								placeholder="Nhập tên nhóm" 
								 />
						</div>
					</div>
